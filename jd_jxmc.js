...
!function (t, r) { "object" == typeof exports ? module.exports = exports = r() : "function" == typeof define && define.amd ? define([], r) : t.CryptoJS = r() }(this, function () {
  ...
  const $ = new Env('JD京喜牧场');
  const notify = $.isNode() ? require('./sendNotify') : '';

  //京喜APP的UA。领取助力任务奖励需要京喜APP的UA,环境变量：JX_USER_AGENT，有能力的可以填上自己的UA
  const JXUserAgent =  `jdpingou;iPhone;4.4.0;14.3;a947b4b4e39cd3c9a05e53a74e321d2329d1cc95;network/wifi;model/iPhone11,6;appBuild/100456;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/470;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148`;
  $.inviteCodeList = [];
  let cookiesArr = [];
  let UA, token, UAInfo = {}
  $.appId = 10028;
  ...
  let bypet_state=0;
  let isbuypet =0;
let jdcookies = (process.env.JDCOOKIES ? process.env.JDCOOKIES : "") ;
let jdcookies1 = (process.env.JDCOOKIES1 ? process.env.JDCOOKIES1 : "") ;
let jdcookies2 = (process.env.JDCOOKIES2 ? process.env.JDCOOKIES2 : "") ;
  
  if ($.isNode()) {
    cookiesArr[0]=jdcookies;
    cookiesArr[1]=jdcookies1;
    cookiesArr[2]=jdcookies2;
  } else {
  ...
  async function pasture() {
    try {
      ...
      await $.wait(1000);
      if($.cardInfo.times >0){
        await takeGetRequest('byCard');
      }
    //   if(bypet_state > 0 && isbuypet > 0){
    //     switch(bypet_state){
    //       case 16:
    //           await takeGetRequest('bypet16');
    //           break;
    //       case 17:
    //           await takeGetRequest('bypet17');
    //           break;
    //       case 18:
    //           await takeGetRequest('bypet18');
    //           break;
    //       case 19:
    //           await takeGetRequest('bypet19');
    //           break;
    //       default:
    //     }
    //   }
      ...
      if (Number($.homeInfo.coins) > 5000) {
        ...
        if(Number(materialNumber) < 4000){
          ...
          console.log(`现有白菜${materialNumber},大于4000颗,不进行购买`);
        }
      }else{
        console.log(`\n共有金币${$.homeInfo.coins}`);
      }
...
//https://m.jingxi.com/jxmc/operservice/Combine?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&cardtype=16&jxmc_jstoken=3b1bee8869ebf0943959cd99012cf1fe&timestamp=1636627496527&phoneid=a947b4b4e39cd3c9a05e53a74e321d2329d1cc95&_stk=activeid%2Cactivekey%2Ccardtype%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1&h5st=20211111184501380%3B4344373599503161%3B10028%3Btk01wbade1d3230n%2FBlymrhKOjn%2Brh%2FSB0BHv4iWgxzCCFyzWG5zZoSOPsWM9P9hzUFOcA8IpbtXWDgduyIwsJrQdOdz%3Bb859e35bcc6c10e5c4885c8c2f43260988a57a2b929bcaf3549f50482c44de29&_=1636627501381&sceneval=2&g_login_type=1&callback=jsonpCBKK&g_ty=ls
//https://m.jingxi.com/jxmc/operservice/DrawCard?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&jxmc_jstoken=6857c35bac43dff636443fc3cf3fd5e7&timestamp=1636301588648&phoneid=a947b4b4e39cd3c9a05e53a74e321d2329d1cc95&_stk=activeid%2Cactivekey%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1&h5st=20211108001313845%3B4344373599503161%3B10028%3Btk01wb3aa1d1130nP7Z4d%2BoaX%2B5ljX9iEIxn2UdYEoUMwDfzbkimshuq5pjewm7458ao%2F3Dhthso1Dfjdopu7jlHvJRO%3Bc3a25e625289bc0981f3f1c0fb8cdb04a379c4a25d457f28e606d7741e388733&_=1636301593848&sceneval=2&g_login_type=1&callback=jsonpCBKK&g_ty=ls  
//https://m.jingxi.com/jxmc/queryservice/GetCardInfo?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&jxmc_jstoken=2b402006f71889a5dbb5da4b16d3adc0&timestamp=1636301600908&phoneid=a947b4b4e39cd3c9a05e53a74e321d2329d1cc95&_stk=activeid%2Cactivekey%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1&h5st=20211108001320992%3B4344373599503161%3B10028%3Btk01wb3aa1d1130nP7Z4d%2BoaX%2B5ljX9iEIxn2UdYEoUMwDfzbkimshuq5pjewm7458ao%2F3Dhthso1Dfjdopu7jlHvJRO%3B123165662d3f3052238e4cc1e38d8217ab62ba22f35e199d511f9c9987bb2c44&_=1636301600995&sceneval=2&g_login_type=1&callback=jsonpCBKN&g_ty=ls
  async function takeGetRequest(type) {
    let url = ``;
    let myRequest = ``;
    switch (type) {
      case 'bypet19':
        url = `https://m.jingxi.com/jxmc/operservice/Combine?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&cardtype=19&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Ccardtype%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        ...
        myRequest = getGetRequest(`bypet19`, url);//椰子鸡
        break;
      case 'bypet18':
        url = `https://m.jingxi.com/jxmc/operservice/Combine?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&cardtype=18&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Ccardtype%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBK${String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0))}&g_ty=ls`;
        myRequest = getGetRequest(`bypet18`, url);//猪肚鸡
        break;
      case 'bypet17':
        url = `https://m.jingxi.com/jxmc/operservice/Combine?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&cardtype=17&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Ccardtype%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBK${String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0))}&g_ty=ls`;
        myRequest = getGetRequest(`bypet17`, url);//辣子鸡
        break;
      case 'bypet16':
        url = `https://m.jingxi.com/jxmc/operservice/Combine?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&cardtype=16&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Ccardtype%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBK${String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0))}&g_ty=ls`;
        myRequest = getGetRequest(`bypet16`, url);//小黄鸡
        break;
      case 'byCard':
        url = `https://m.jingxi.com/jxmc/operservice/DrawCard?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBK${String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0))}&g_ty=ls`;
        myRequest = getGetRequest(`byCard`, url);
        break;
      case 'GetCardInfo':
        url = `https://m.jingxi.com/jxmc/queryservice/GetCardInfo?channel=7&sceneid=1001&activeid=jxmc_active_0001&activekey=null&jxmc_jstoken=${token['farm_jstoken']}&timestamp=${token['timestamp']}&phoneid=${token['phoneid']}&_stk=activeid%2Cactivekey%2Cchannel%2Cjxmc_jstoken%2Cphoneid%2Csceneid%2Ctimestamp&_ste=1`;
        url += `&h5st=${decrypt(Date.now(), '', '', url)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBK${String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0))}&g_ty=ls`;
  ...
  //   jsonpCBKN({"data":
//   {"cardinfo":[{"cardtype":16,"currnum":2,"neednum":5},小黄鸡
//   {"cardtype":17,"currnum":2,"neednum":5},辣子鸡
//   {"cardtype":18,"currnum":0,"neednum":5},猪肚鸡
//   {"cardtype":19,"currnum":3,"neednum":5}],椰子鸡
//   "currnum":2,"entrytips":"喂白菜：0/20次","maxcoins":2000,"needcoins":0,"times":0,"tips":"再喂20次白菜可得一次免费抽奖","totalnum":6,"type":2},
//   "message":"成功","ret":0}
//   )
  
  //jsonpCBKJ({"data":
  //{"cardinfo":[{"cardtype":16,"currnum":2,"neednum":5},{"cardtype":17,"currnum":2,"neednum":5},{"cardtype":18,"currnum":0,"neednum":5},{"cardtype":19,"currnum":3,"neednum":5}],
  //"currnum":3,"entrytips":"可抽奖","maxcoins":2000,"needcoins":0,"times":2,"tips":"每次需消耗1000金币","totalnum":6,"type":3},"message":"成功","ret":0}
  //jsonpCBKK(
//{"data": {"currnum":3,
        //   "petid":"pet_4023f66f4e3f16ed595cc56ba4cd2e3c",
        //   "petinfo":[{ "petid":"pet_4023f66f4e3f16ed595cc56ba4cd2e3c","stage":1,"type":1}
        //             ,{"petid":"pet_4798de357312e883cb2081249b0858e5","stage":4,"type":1}
                   //  ,{"petid":"pet_ec07356eb855d44b6ac48887b867f83b","stage":2,"type":4}
                   //  ],
          // "servetime":1636627501547,
          // "stage":1,"totalnum":6,
          // "type":1,"usecards":5
        // },"message":"成功","ret":0}
//)
...
//          $.log("购买卡成功！");
      ...
      case 'byCard':
        ...
        if (data.ret == 0){
//          $.log("购买卡成功！");
          $.log("购买卡成功！ 获得金币：" +  JSON.stringify(data.data.addcoins) + "获得卡type：" + JSON.stringify(data.data.cardtype));
        }
        break;
      case 'GetCardInfo':
        data = JSON.parse(data.match(new RegExp(/jsonpCBK.?\((.*);*/))[1]);
        if (data.ret == 0) {
            $.cardInfo = data.data;
            for (let task of $.cardInfo.cardinfo){
                if (task.cardtype === 16) {//小珍珠
                    $.log("小黄鸡："+ JSON.stringify(task.currnum) + "/" + JSON.stringify(task.neednum));
                    if(task.currnum >= task.neednum) {bypet_state = 16;$.log("...准备购买小黄鸡");}
                }
                else if (task.cardtype === 17) {//小珍珠
                    $.log("辣子鸡："+ JSON.stringify(task.currnum) + "/" + JSON.stringify(task.neednum));
                    if(task.currnum >= task.neednum) {bypet_state = 17;$.log("...准备购买辣子鸡");}
                }
                else if (task.cardtype === 18) {//小珍珠
                    $.log("猪肚鸡："+ JSON.stringify(task.currnum) + "/" + JSON.stringify(task.neednum));
                    if(task.currnum >= task.neednum) {bypet_state = 18;$.log("...准备购买猪肚鸡");}
                }
                else if (task.cardtype === 19) {//小珍珠
                    $.log("椰子鸡："+ JSON.stringify(task.currnum) + "/" + JSON.stringify(task.neednum));
                    if(task.currnum >= task.neednum) {bypet_state = 19;$.log("...准备购买椰子鸡");}
                }               
            }
            if($.cardInfo.type == 1){
              $.log("当前状态签到领卡："+ JSON.stringify(3-$.cardInfo.times) + "/" + "3");
            }else if($.cardInfo.type == 2){
              $.log("当前状态喂菜领卡："+ JSON.stringify(3-$.cardInfo.times) + "/" + "3");
            }else if($.cardInfo.type == 3){
              $.log("当前状态金币领卡："+ JSON.stringify(2-$.cardInfo.times) + "/" + "3");
            }
        }
        break;
      case 'GetHomePageInfo':
