...
function withDraw0() {
  return new Promise((resolve, reject) => {
      const url = {
          ...
          body: `p=9NwGV8Ov71o%3DGvDnjwMsu_ld4qx0YVkhCGSN79Nz9uYVd_6x03zS0fnS8kKdOyWyDMKSICaFBvwH5U4nsR_vvJsjHH2Z81CBL7eyJjtPmVfyM0x8EAsS-_ESh4-JImy11uTAadxMJCYAdD7P_w27pQt6_tIUTgtnDG7LOKwRL-IZbYYNciqqQLK6yDwesU8ZSSrIqoN5VSicJJfeMSKhzHVtKYVsAdaKFPleugxFlDitqBES8-cnh1lXwSjDB8B8YW593gQTzNU11006iICeXD3Syy7CxFqxMWyVsW4kZuS8DvXuCGwDcAZtrWSE4sxP4Wrgxtf7ACZ2loREFKWCm9FaAgtytxVF2ega9rOPKFKFTcLqsUMV7FtUstgU1FY4cZTMPGoKoxrj3lO8cUOaFMXi2-HCMJv7Z3GPq0R-_T00cEuhm5s49uqcRbMv3ro2Uno0rQQ5l5ku9ui306TVHMxiLQBn5jPyXSCP3QYdYXrD12jKXLozfJFkhrleE0x4PjFBGUo36sBTekfK5lrGkJbMPrMylvdlhA8pu2Onyqy-q7f2EoY3f7S2IDTaMNWCGw40sjmqTGxHgF_F0YxD1y1dAN-oLDp-ivz128WoEQtJN-qENlIX8zIwivLZ3k3n8rUe3VwKmh6KHW8NHSZMLB89Oq-Acl52hj41d47fCstqUn2EthT9iX3fx_qsyC8UjFb4W9kCc2nqW6OJvnJePSZJjenNz3_U5lFrYdEluHT7-mWBShMxokgPVg5DOAUzKp9Yn9PN1BqR_od-wMBE6OohzdQZOIMeb8jivY_LNO0OOZRyVETKHb5MfRcL7e8g4I4nostOKXFBKyrz47uomd4%3D` ,
      ...
      $.post(url, (error, resp, data) => {
          ...
          if (withDrawres.error_code == 0) {
              ...
              $.log(`自动提现失败，`+JSON.stringify(withDrawres))
          } else {
              $.log(`自动提现失败，`+JSON.stringify(withDrawres))
          }
          resolve()
...
function withDraw1() {
  return new Promise((resolve, reject) => {
      const url = {
          ...
          body: `p=9NwGV8Ov71o%3DgW5NEpb6rjb84bkaCQyOq-myT0C-Ktb_mEtDEGsOrBruuZzIpWlevTEf2n4e6SDtwtHI8jh7tGLFm1iscPtbZwlhO1--2rPMqEVay5SHQZ0Xa5om9y_QnFioIoDSg-ArtrfwznZt1IhRAOspLNm4F1Z4mRILDUTDM9AS-u45jBB6TSED8EkO9y3TUC1D1zhuk3GHZuPZXt3sCrvC6aBEJ_XzlkWcBFh6BYM1wFVPkrB0WKjX_T5ZlE8Wpos_tRSyK3_VKAaUykzdfhRxg6a8IvrWwGV88OAAPQslSmF9IYxNUJoGK4EPQU0kCyo6Ib_lqbZai2r2NajgNmzKfXB54XEfCZauhvKEL29pFbLGtLL5O61eHbS45qEUgQUFgo6D83H0m7mDveg4rnBVi87xvRnHA2CygYPOLPZhZGiRGa0jdBKu7IyzOHzzbTElT6lfOSLQQ441Dp7Zjp1M1NP2HHDiIgUlDTtQJuJZJeYRdjxbiPp2k90fK5mnLQmdFl1ZzLr7NolQDdo39E76FrDvIIrm57uKQAgSA3fsQEoKi147IFsi_OEeTmMwZ2w42Om-ALSDKsBPmOgIpAq_9qBVYU9Q-GcStoipjxMjw_O26Ueh8Q7iKihyG2-PLP7ar6juDq4OOrDzNcY-tnYCppvw0EdTuV-OYcQrbiRqA-ew8AW1CenzgZsyRreUCXOwd3Fx-t9grx4rY8OWX523QDmNVLm9YIiaYXF6Mb30QoUFTY5Vwfw2TpoTss8nBM7L3MWjH2ostLynxNkUTiQ81cmbpTmwi8hxYe9MCydzB9nZ1C4swm4h8wOixHgEWvhxgPT7BNlklFBntXU%3D` ,
...
async function showmsg() {
    $.notify_status = false;
    if(JSON.parse($.time("HH"))> 223 ){$.notify_status = true;}
    console.log(JSON.stringify($.notify_status));
    if ($.isNode() && rotaryres.status !== 0 && rotarytimes && (100 - rotarytimes) % 95 == 0 && cash >= 10) {
      ...
      if($.notify_status == true){
        await notify.sendNotify($.name + " " + nick, $.sub+ '\n' +$.des)
      }
      ...
      if($.notify_status == true){ 
      await notify.sendNotify($.name + " " + nick, rotarynum+ '\n' + $.sub+ '\n' +$.des)
      }
